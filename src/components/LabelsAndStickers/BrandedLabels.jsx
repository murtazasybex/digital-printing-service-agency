        ...
        <div className="w-full max-w-[1200px] ml-auto">
          <div className="">
            <h1 className="font-bold text-[28px] mt-7 pl-3 px-2 inter">
              Branded labels that get noticed
            </h1>
            <p className="text-[17px] pb-6 pt-2 pl-3 px-2 inter">
              Create a matching look across marketing, merchandise and mail with
              custom labels.
            </p>
          </div>
          <div className="flex lg:justify-start justify-center flex-wrap relative overflow-hidden gap-3">
            {brandLabels.map((post, index) => (
              <div
                key={index}
